...
export const nodeCatalog: NodeCatalogItem[] = [
  ...
  },
  {
    ...
    defaultConfig: { capabilities: [], operations: [], requiresApproval: true },
  },
  {
    ...
    defaultConfig: { branch: 'factory/change', baseRevision: '', requiresApproval: true },
  },
  {
    ...
    defaultConfig: { message: 'Apply workflow change', paths: [], requirePatchArtifact: false, requiresApproval: true },
  },
  {
    type: 'repositoryPush',
    ...
    defaultConfig: { remote: 'origin', branch: '', allowedRemotes: ['origin'], requiresApproval: true },
  },
  {
