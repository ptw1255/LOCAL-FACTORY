...
export const api = {
  ...
  saveProjectFiles: (projectId: string, files: Array<{ path: string; content: string; expectedSha256?: string }>) => request<{ files: ProjectFileRecord[] }>(`/api/projects/${encodeURIComponent(projectId)}/files/batch`, { method: 'PUT', body: JSON.stringify({ files }) }),
